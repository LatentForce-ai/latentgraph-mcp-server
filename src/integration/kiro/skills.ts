...
name: lgraph-cli
description: "Use when the user needs to run Latentgraph CLI commands like initialize a repo, trigger a full re-scan, check status, or configure the MCP server. Examples: \\"Index this repo\\", \\"Refresh the DRG\\", \\"Check lgraph status\\", \\"Configure Kiro\\""
---
