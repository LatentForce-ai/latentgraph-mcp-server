/**
 * AGENTS.md generation for Latentgraph opencode integration.
 *
 * opencode loads AGENTS.md automatically as project-level instructions,
 * equivalent to CLAUDE.md in Claude Code. This file injects the mandatory
 * lgraph MCP usage rules into every opencode session for the project.
 */
