/**
 * Skill guide generation for Latentgraph GitHub Copilot integration.
 *
 * Generates .github/skills/lgraph-<name>/SKILL.md for each of the five
 * lgraph skill guides, mirroring the layout used for Claude Code.
 */
...
| Configure GitHub Copilot in the current repo | \`lgraph add copilot\` |
